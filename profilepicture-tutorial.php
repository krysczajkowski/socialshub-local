            ...
            <div class="col-10 col-md-6 col-lg-4 offset-1 offset-md-3 offset-lg-4 border mt-5 p-4">
                <form action="" method='POST' enctype='multipart/form-data'>
                    ...
                    <div class="form-group text-center">
                        <img src="images/defaultProfileImage.png" id='profileDisplay' class='rounded-circle w-50 h-50 d-block mx-auto my-3' alt="" onclick='profileImageClick()'>
                    ...
                    <div class="form-group">
                        <button type="submit" name='submit' class='btn btn-primary btn-block'>Go to profile</button>
                    </div>
                </form>
            </div>
        </div>
