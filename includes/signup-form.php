...
<form action="" method="post" id='i-recaptcha'>
    ...
    <input type="submit" class='g-recaptcha btn btn-success btn-block mt-2' value = 'Sign Up' data-sitekey="6Lf5G6EUAAAAACxEz6LkYthE5F00o-8-heFqtrYq" data-callback="onSubmit" >
